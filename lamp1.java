...
public class lamp1 extends JFrame {
	...
	public lamp1() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!(ls.isEmpty() || ws.isEmpty() || lpans.isEmpty() || wpans.isEmpty())) {
					...
					l = new Float(ls);
					w  = new Float(ws);
					lpan = new Float(lpans);
					wpan = new Float(wpans);
					if (((l - 2) / lpan) == (int)((l - 2) / lpan) && ((w - 2) / wpan) == (int)((w - 2) / wpan)) {
						n = ((l - 2)*(w - 2)) / (lpan*wpan);
						
					}
					else if (((l - 2) / lpan) != ((int)((l - 2) / lpan))) {
						if (((w - 2) / wpan) != ((int)((w - 2) / wpan))) {
							n = Math.ceil(((w - 2) / wpan) * Math.ceil((l - 2) / lpan));
		...
		btnNewButton.setBounds(291, 378, 171, 36);
		...
		JLabel lblNewLabel_4 = new JLabel("\u0412\u0430\u043C \u043F\u043E\u0442\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044F \u043B\u0430\u043C\u0438\u043D\u0430\u0442 \u0432 \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u0435, \u0448\u0442:");
		lblNewLabel_4.setFont(new Font("Arial", Font.PLAIN, 18));
		lblNewLabel_4.setBounds(23, 488, 371, 23);
