...
////////////////////////////////////// Обои /////////////////////////////////////////////////
	...
	public ob1() {
		...
		btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!(hs.isEmpty() || ls.isEmpty() || lrs.isEmpty() || wrs.isEmpty())) {
					...
					h = new Float(hs); // A
					l = new Float(ls); // P
					lrul = new Float(lrs); // a
					wrul = new Float(wrs); // b
					dP = getFraction(lrul/h);
					cP = Math.floor(lrul/h);
					if(lrul/h==cP) {
						n = Math.ceil(l/(lrul/h*wrul));
						
					}
					else {
						if(dP>=0.95 && dP<=0.99)n = Math.ceil(l/(Math.ceil(lrul/h)*wrul));
						else n=Math.ceil(l / (cP * wrul));
						
					}
					
					JOptionPane.showMessageDialog(null, (int)n);
				}
				else {
		...
		btn.setBounds(291, 378, 171, 36);
		panel.add(btn);
		
		JLabel label_4 = new JLabel("\u0412\u0430\u043C \u043F\u043E\u0442\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044F \u043E\u0431\u043E\u0438 \u0432 \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u0435, \u0448\u0442:");
		label_4.setFont(new Font("Arial", Font.PLAIN, 18));
		label_4.setBounds(23, 488, 371, 23);
		panel.add(label_4);
		
		result = new JTextField();
		result.setColumns(10);
		result.setBounds(404, 488, 127, 23);
		panel.add(result);
		
		JLabel lblNewLabel = new JLabel("\u0440\u0443\u043B\u043E\u043D\u043E\u0432");
		lblNewLabel.setFont(new Font("Arial", Font.PLAIN, 18));
		lblNewLabel.setBounds(541, 488, 101, 20);
